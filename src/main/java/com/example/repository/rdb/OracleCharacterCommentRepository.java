...
import com.example.mapper.oracle.mapper.OracleCharacterCommentMapper;
import com.example.repository.CharacterCommentRepository;

@Transactional
@Service
@ConditionalOnProperty(name = "db.type", havingValue = "oracle")
public class OracleCharacterCommentRepository implements CharacterCommentRepository {

    private final OracleCharacterCommentMapper mapper;

    public OracleCharacterCommentRepository(OracleCharacterCommentMapper mapper) {
        this.mapper = mapper;
    }
